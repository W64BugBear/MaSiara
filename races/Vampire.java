...
public class Vampire {
	public static void becomeVampire(Hero hero, SerializableInformation sInf, SkillsPanel skillsPanel)
	{
		...
		for (int i = 0; i < strings.length; i++)
			combo.addItem(new Skill(strings[i], false, 1, null, Skill.TYPE_COMPLEX, Skill.GROUP_NONE));
	}
