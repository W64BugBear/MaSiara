	...
	implements ItemListener
{
	...
	public EardonsHouse ()
	{
		super ("Eardons Haus", true, true, true, Race.RICH, "Eardinger dürfen sich eine beliebige Eigenschaft aussuchen, für die der Rassenmodifikator +1 ist. Außerdem dürfen sie Ausdauer zum halben Preis steigern, solang es nicht höher ist als die Z.", "keine", "eardinger");
		LinkedList<RaceModifiers> rm = new LinkedList<RaceModifiers>();
		rm.add(new RaceModifiers("Mensch", 
				0, 0, 0, 0, 0, 0, 0, 	// physical attributes
				0, 0, 0, 0, 0, 0, 0,	// mental attributes
				0, 0, 0, 0, 0, 0, 	// senses
				0, 0, 0,
