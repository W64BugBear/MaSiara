	...
	implements ItemListener
{
	...
	public HighElves() {
		super ("Hochelfen", true, true, true, Race.RICH, "Gw+1, K-1, Z-1, In+1; MR: 3 (siehe dazu: Elfen); alle Sinne + 9\nIm Fernkampf erhalten sie zusätzlich +3.\nIm Umgang mit Pferden sind für Hochelfen (nicht Grauelfen) alle Proben um 3 (normal) bis 5 (Elfenross) erleichtert.\nEin Hochelf muss 10 Punkte Einschränkungen aus folgender Liste wählen oder Fertigkeitspunkte aufwenden, um sie auszugleichen: Arroganz, Ehrgefühl, Eitelkeit, Krankhafte Reinlichkeit, Stolz, Weltfremdheit\n", "Im Fernkampf erhalten sie zusätzlich +3.\nIm Umgang mit Pferden sind für Hochelfen (nicht Grauelfen) alle Proben um 3 (normal) bis 5 (Elfenross) erleichtert.","h11");
...
//		return new SpecialsPanel();
	...
	public void remove (MainWindow father)
	{
		...
		hero.getProperty("Zï¿½higkeit").setMaximumInt(25);
		sInf.increaseEP(-350);
